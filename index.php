...
<html lang="en">
  <head>
    ...
    <script src="//code.tidio.co/uhauzyfsnwkimwejgsrkrnaad2ozmajj.js" async></script>
    <meta name="google-site-verification" content="I2QF4kOGbQLW1nopy82LvQfGwqI-s95wicdEtdmUdfY" />
    <style>
  ...
  <body class="bg-dark">
    ...
    <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            ...
            <div class="col-lg-6">
                <h1 class="d-none">Cybergenix IT Solutions</h1>
        ...
        <div class="m-0 mb-4 p-0  d-flex flex-wrap justify-content-center align-items-center">
            <div role="button"class="col-3 item1 d-flex justify-content-center align-items-center flex-column mx-4 p-2 text-light overflow-hidden "style="width:17em;height:25em;">
                <div class="w-100 border border-bottom-0 rounded-top-4 overflow-hidden"style="height:40%;">
                    <img class="object-fit-cover" style="width:100%;height:100%;"src="images/yesindia.jpg" alt="Project Image">
                </div>
                <div class="bg-primary text-center rounded-bottom-4 p-1"style="height:60%;">
                    <h4>Online Coaching</h4>
                    <p class="lh-1">An online coaching management system with subscription-based material access, online exams, result reporting, analytics, and subject-wise, chapter-based content delivery.</p>
                    <p>Price <span>₹45000</span> Timing <span>40 Day</span></p>
                </div>
            </div>
            <div role="button"class="col-3 item1 d-flex justify-content-center align-items-center flex-column mx-4 p-2 text-light overflow-hidden "style="width:17em;height:25em;">
                <div class="w-100 border border-bottom-0 rounded-top-4 overflow-hidden"style="height:40%;">
            ...
            <div role="button"class="col-3 item3 d-flex justify-content-center align-items-center flex-column mx-4 p-2 text-light overflow-hidden "style="width:17em;height:25em;">
                <div class="w-100 border border-bottom-0 rounded-top-4 overflow-hidden"style="height:40%;">
                    <img class="object-fit-cover" style="width:100%;height:100%;"src="images/project3.jpg" alt="Project Image">
                </div>
                <div class="bg-primary text-center rounded-bottom-4 p-1"style="height:60%;">
                    <h4>Hotel Management System with CMS Admin Panel</h4>
                    <p class="lh-1">Manage bookings, rooms, customers with ease. Includes a powerful admin panel to update content, track performance, and control everything in one place.</p>
                    <p>Price <span>₹15000</span> Timing <span><span>25 Day</span></p>
                </div>
            </div>
        </div>

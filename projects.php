  ...
  <!-- projects -->
   ...
   <div class="projectContainer container mb-5 d-flex justify-content-center align-items-top flex-wrap">
      <div class="card m-2 p-3 rounded-4 bg-dark" data-name="application">
        <div class="card-image rounded-3 d-flex justify-content-center align-items-center"><img src="images/yesindia.jpg" class="img-thumbnail" alt="Project Image"style="object-fit: contain;"></div>
        <p class="fs-4 fw-semibold card-title text-primary m-3">YesIndia <span class="text-center text-scondary fw-bold"style="font-size: 13px;color: #b3b3b3;">( APPLICATION )</span></p>
        <p class="card-body text-light">
        An online coaching management system with subscription-based material access, online exams, result reporting, analytics, and subject-wise, chapter-based content delivery Download on Playstore <a href="https://play.google.com/store/apps/details?id=com.cybergenix.yesindia&pcampaignid=web_share" target="_blank">LINK</a>
        </p>
        <p class="text-end mx-3 text-scondary"style="font-size: 13px;color: #b3b3b3;">Time Duration <span class="fw-bold">16-11-2025</span> to <span class="fw-bold">20-01-2026</span></p>
      </div>
